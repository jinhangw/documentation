function [image, groundProbImageBeforeMaxing]= APPgetLabeledImage2(image, imsegs, pv, ph)
...
if ndims(pv)==2
    ...
    groundProb = pv(:,1);
    groundProbImageBeforeMaxing = groundProb(imsegs.segimage);
...
if 0 % set do draw subclass marks
